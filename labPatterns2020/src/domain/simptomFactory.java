...
public class simptomFactory {

	public simptomFactory() {}
	...
	public Symptom createSymptom(String symptomName) {
	    ...
	    List<String> impact1 = Arrays.asList("nauseas", "v�mitos", "congesti�n nasal","diarrea","hemoptisis","congestion conjuntival");
