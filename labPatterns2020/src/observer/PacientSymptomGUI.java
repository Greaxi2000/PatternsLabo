...
public class PacientSymptomGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PacientSymptomGUI(Observable pacient) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//addSymptomByName ...
		    	((Covid19Pacient) pacient).addSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName(), new Integer(weightField.getText()));
		...
		btnRemoveSymptom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//removeSymptomByName...
		    	((Covid19Pacient) pacient).removeSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName());
		...
		labelPacient.setText(((Covid19Pacient) pacient).getName());
